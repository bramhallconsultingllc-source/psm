...
# ============================================================
# HERO SCORECARD (RENDER VIA components.html to avoid escaping)
# ============================================================
...
<div class="hero">
  ...
  <div class="grid">
    ...
    <div class="card" style="border-left-color:{swb_c};">
      ...
      <div class="kpi-detail">Target ${params.target_swb_per_visit:.0f} ± ${params.swb_tolerance:.0f} <b style="color:{swb_c};">({swb_s})</b></div>
    </div>
    ...
    <div class="card" style="border-left-color:{util_c};">
      ...
      <div class="kpi-detail">Target {ui["target_utilization"]}% <b style="color:{util_c};">({util_s})</b></div>
    </div>
...
"""
components.html(hero_html, height=330)
